...
def _isolate_user_config(tmp_path_factory, monkeypatch):
    ...
    Points XDG_CONFIG_HOME/XDG_CACHE_HOME at fresh temp dirs and clears NFIND_CONFIG and
    NFIND_ENDPOINT_CACHE so the default config-file and endpoint-cache lookups find nothing
